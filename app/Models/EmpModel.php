...
class EmpModel extends Model
{
	...
	protected $fillable = ['name', 'bday', 'sex_id', 'edu_code', 'alamat', 'kota', 'provinsi', 'goldarah', 'insertnew'];
	private static $SQL_ForLookUp_one = 'select * from emp_one_view';	//two-807
	...
	{
		//[{"status":"OK"}]		two-1000
		return DB::select( "CALL emp_one_delete( ? )", [ $id ] );
	}
