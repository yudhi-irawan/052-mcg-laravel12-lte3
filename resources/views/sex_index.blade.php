				...
				<div class="col-12">
					...
					<div class="card card-primary">
						<div class="card-header">
							<h3 class="card-title" id="title_one">Sex</h3>
...
<script>
	...
	var ___datatable_list_one = $("#datatable_list_one").DataTable({
		...
		columns: [
			...
			,{ title: "Sex Description", data: "description", width: "20%" }
		],
		buttons: {
			dom: {
				button: {
	...
	$(document).on('click', '.deleteIcon_one', function(e) {
		...
		Swal.fire({
			...
			if (result.isConfirmed) {
				$.ajax({
					url: '{{ route('sex_delete_one') }}',	//delete
					method: 'delete',
					data: {
					id: id,
					_token: csrf
